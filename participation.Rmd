...
```{r setup, echo = F}
# Tom wrote all of this document, aside from the stuff he copied from the two Word files.
# He doesn't know who wrote those, but Mimiko sent them to him.
options(width = 120)
```
<style>
...
## The questionnaire
A questionnaire was developed using critical participatory action research* as the methodological approach.
